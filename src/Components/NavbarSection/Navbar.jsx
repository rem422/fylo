            ...
            <div className="nav">
                ...
                <div className="navMenu">
                  <nav className={isMobile && isNavOpen ? 'open' : undefined}>
                    ...
                    <ul>
                      <li>
                        <Link to='hero' onClick={() => setIsNavOpen(false)}>Home</Link>
                      </li>
                      <li>
                        <Link to='features' onClick={() => setIsNavOpen(false)}>Features</Link>
                      </li>
                      <li>
                        <Link to='team' onClick={() => setIsNavOpen(false)}>Team</Link>
                      </li>
                      <li>
                        <Link to='testimonials' onClick={() => setIsNavOpen(false)}>Testimonials</Link>
                      </li>
                      <li>
                        <Link to='Newsletter' onClick={() => setIsNavOpen(false)}>Sign In</Link>
                      </li>
                    </ul>
                  </nav>
                  {isMobile && (
